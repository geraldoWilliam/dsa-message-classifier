...
def gen_reports():
    ...
    MNB_freq_inb_s = pickle.load(open('output/MNB_freq_inb_s.pkl', 'rb'))
    MNB_freq_bal_s = pickle.load(open('output/MNB_freq_bal_s.pkl', 'rb'))
    tree_freq_inb_s = pickle.load(open('output/tree_freq_inb_s.pkl', 'rb'))
    tree_freq_bal_s = pickle.load(open('output/tree_freq_bal_s.pkl', 'rb'))
    ...
    print get_headers('MultinomialNB', 'freq', False, False)
    generate_report(MNB_freq_inb, dataset_freq_inb, dataset_label)
    print "*****************************\n"

    print get_headers('MultinomialNB', 'freq', False, True)
    generate_report(MNB_freq_inb_s, dataset_freq_inb_s, dataset_label)
    print "*****************************\n"

    print get_headers('MultinomialNB', 'freq', True, False)
    generate_report(MNB_freq_bal, dataset_freq_bal, dataset_label_bal)
    print "*****************************\n"

    print get_headers('MultinomialNB', 'freq', True, True)
    generate_report(MNB_freq_bal_s, dataset_freq_bal_s, dataset_label_bal)
    print "*****************************\n"

    print "\n\n"

    print get_headers('DecisionTree', 'freq', False, False)
    generate_report(tree_freq_inb, dataset_freq_inb, dataset_label)
    print "*****************************\n"

    print get_headers('DecisionTree', 'freq', False, True)
    generate_report(tree_freq_inb_s, dataset_freq_inb_s, dataset_label)
    print "*****************************\n"

    print get_headers('DecisionTree', 'freq', True, False)
    generate_report(tree_freq_bal, dataset_freq_bal, dataset_label_bal)
    print "*****************************\n"

    print get_headers('DecisionTree', 'freq', True, True)
    generate_report(tree_freq_bal_s, dataset_freq_bal_s, dataset_label_bal)
    print "*****************************\n"
