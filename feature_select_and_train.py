...
def main():
	training_data = pd.read_csv('feature_extraction/feature_freq.csv')
	balanced_training_data = pd.read_csv('feature_extraction/feature_balanced.csv')
	label = pd.read_csv('feature_extraction/label')
	balanced_label = pd.read_csv('feature_extraction/balanced_label')
